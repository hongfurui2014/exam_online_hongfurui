<template>
  <div>
    ...
    <el-card body-style="padding: 5px 10px;">
      <!-- 搜索表单 -->
      <el-form label-position="right" label-width="70px" :model="searchsubjectForm" size="mini">
        <el-row :gutter="10">
    ...
    <el-dialog title="添加科目" :visible.sync="addSubjectDialogVisible" width="300px">
      <el-form label-position="right" label-width="70px" :model="addSubjectForm" size="mini">
        <el-row>
          <el-form-item label="科目名称">
    ...
    <el-dialog title="修改科目" :visible.sync="updateSubjectDialogVisible" width="300px">
      <el-form label-position="right" label-width="70px" :model="updateSubjectForm" size="mini">
        <el-row>
          <el-form-item label="科目名称">
